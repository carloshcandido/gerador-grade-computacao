export const DADOS_CURSO = {
    "1": [
        ...
        { id: '1P6', nome: 'Lógica para Computação', creditos: 3, preRequisitos: {}, horarios: [{ dia: 2, slots: [5, 6] }, { dia: 2, slots: [8] }] },
    ...
    "2": [
        ...
        { id: '2P3', nome: 'Álgebra Linear', creditos: 4, preRequisitos: { cursos: ['1P1', '1P3', '1P4'] }, horarios: [{ dia: 1, slots: [5, 6] }, { dia: 2, slots: [5, 6] }] },
        { id: '2P4', nome: 'Mecânica Clássica', creditos: 5, preRequisitos: { cursos: ['1P4'] }, horarios: [{ dia: 4, slots: [5, 6] }, { dia: 5, slots: [4, 5, 6] }] },
    ...
    "3": [
        ...
        { id: '3P2', nome: 'Cálculo a várias Variáveis', creditos: 5, preRequisitos: { cursos: ['2P2'] }, horarios: [{ dia: 4, slots: [5, 6] }, { dia: 5, slots: [4, 5, 6] }] },
    ...
    "4": [
        { id: '4P1', nome: 'Equações Diferenciais Ordinárias I', creditos: 4, preRequisitos: { cursos: ['2P3', '3P2'] }, horarios: [{ dia: 3, slots: [4, 5, 6] }, { dia: 3, slots: [8] }] },
        ...
        { id: '4P4', nome: 'Arquitetura de Computadores', creditos: 6, preRequisitos: { cursos: ['3P4'] }, horarios: [{ dia: 2, slots: [5, 6] }, { dia: 5, slots: [2, 4, 5, 6] }] },
    ...
    "5": [
        ...
        { id: '5P2', nome: 'Sistemas Operacionais', creditos: 4, preRequisitos: { cursos: ['4P4'] }, horarios: [{ dia: 3, slots: [0] }, { dia: 4, slots: [5, 6] }] },
        { id: '5P3', nome: 'Redes de Computadores II', creditos: 6, preRequisitos: { cursos: ['4P3'] }, horarios: [{ dia: 4, slots: [0, 1, 2, 4] }, { dia: 5, slots: [5, 6] }] },
        { id: '5P4', nome: 'Circuitos Lineares', creditos: 4, preRequisitos: { cursos: ['4P1', '4P2'] }, horarios: [{ dia: 1, slots: [5, 6] }, { dia: 2, slots: [5, 6] }] },
    ...
    "6": [
        { id: '6P1', nome: 'Sinais e Sistemas', creditos: 4, preRequisitos: { cursos: ['2P3', '4P1'] }, horarios: [{ dia: 2, slots: [5, 6] }, { dia: 4, slots: [2, 4] }] },
    ...
    "7": [
        ...
        { id: '7P3', nome: 'Processamento Digital de Sinais', creditos: 4, preRequisitos: { cursos: ['6P1'] }, horarios: [{ dia: 1, slots: [5, 6] }, { dia: 2, slots: [5, 6] }] },
    ...
    "9": [
        { id: '9P1', nome: 'Computação de Alto Desempenho', creditos: 4, preRequisitos: { cursos: ['4P5', '8P1'] }, horarios: [{ dia: 2, slots: [5, 6] }, { dia: 3, slots: [5, 6] }] },
    ...
    "10": [
        { id: '10P1', nome: 'Trabalho de Conclusão de Curso II', creditos: 2, preRequisitos: { cursos: ['9P2'] }, horarios: [{ dia: 2, slots: [5, 6] }] }
    ],
    "optativas": [],
    "outros": []
};